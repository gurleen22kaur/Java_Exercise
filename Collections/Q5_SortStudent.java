...
public class Q5_SortStudent {
    ...
    public static void main(String[] args) {
        ...
        studentList.add(new Student("Tom", 45.00, 32.00));
        studentList.add(new Student("Dyna", 455.00, 73.00));
        studentList.add(new Student("Heena", 55.00, 23.00));
        studentList.add(new Student("Pooja", 35.00, 93.00));
        studentList.add(new Student("Rohan", 75.00, 53.00));
        studentList.add(new Student("Rashi", 855.00, 13.00));
        studentList.add(new Student("Rashi", 455.00, 83.00));
